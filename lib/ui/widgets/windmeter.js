...
var subscribes = {
  'environment.wind.angleApparent': function(sourceId, stream) {
    if (!this.widget.props.activeStreams['environment.wind.angleApparent']) {
      ...
      this.widget.props.activeStreams['environment.wind.angleApparent'] = theStream.onValues(function(value, timestamp) {
        console.log(that.widget.props.initPath, timestamp, typeof timestamp)
        that.widget.props.values.angleApparent = value;
        that.widget.props.values.timestamp = timestamp;
  ...
  'environment.wind.angleTrueGround': function(sourceId, stream) {
    if (!this.widget.props.activeStreams['environment.wind.angleTrueGround']) {
      ...
      this.widget.props.activeStreams['environment.wind.angleTrueGround'] = theStream.onValues(function(value, timestamp) {
        console.log(that.widget.props.initPath, timestamp, typeof timestamp)
  ...
  'environment.wind.angleTrueWater': function(sourceId, stream) {
    if (!this.widget.props.activeStreams['environment.wind.angleTrueWater']) {
      ...
      this.widget.props.activeStreams['environment.wind.angleTrueWater'] = theStream.onValues(function(value, timestamp) {
        console.log(that.widget.props.initPath, timestamp, typeof timestamp)
  ...
  'environment.wind.speedApparent': function(sourceId, stream) {
    ...
    if (!this.widget.props.activeStreams['environment.wind.speedApparent']) {
      ...
      this.widget.props.activeStreams['environment.wind.speedApparent'] = theStream.onValues(function(value, timestamp) {
        console.log(that.widget.props.initPath, timestamp, typeof timestamp)
  ...
  'environment.wind.speedOverGround': function(sourceId, stream) {
    ...
    if (!this.widget.props.activeStreams['environment.wind.speedOverGround']) {
      ...
      this.widget.props.activeStreams['environment.wind.speedOverGround'] = theStream.onValues(function(value, timestamp) {
        console.log(that.widget.props.initPath, timestamp, typeof timestamp)
  ...
  'environment.wind.speedTrue': function(sourceId, stream) {
    ...
    if (!this.widget.props.activeStreams['environment.wind.speedTrue']) {
      ...
      this.widget.props.activeStreams['environment.wind.speedTrue'] = theStream.onValues(function(value, timestamp) {
        console.log(that.widget.props.path, timestamp, typeof timestamp)
    ...
    return (
      <svg onClick={this.changeDisplayMode} height="100%" width="100%" viewBox="0 0 400 400">
        ...
        <text x="200" y="24" textAnchor="middle" fontSize="20">{displayValues.label}</text>
          ...
          <text x="200" y="152" textAnchor="middle" fontSize="12">
            {moment(displayValues.timestamp).fromNow()}
          </text>
