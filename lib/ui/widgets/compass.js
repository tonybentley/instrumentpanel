...
function Compass(id, options, streamBundle, instrumentPanel) {
  ...
  var timestampStream = streamBundle.getStreamForSourcePath(options.sourceId, options.path+'.'+options.sourceId);
...
Compass.prototype.updateStream = function(widget, valueStream, timestampStream) {
  widget.widgets = [React.cloneElement(widget.widgets[0],{
    label: widget.options.label,
    value: valueStream,
    timestamp: timestampStream
  }),
